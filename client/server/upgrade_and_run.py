#!/usr/bin/env python3
"""Upgrade database schema to include all AR fields and run diverse products"""

import sqlite3
import json
from database import add_product, delete_product, get_all_products

DATABASE = 'retailflow.db'

def upgrade_database_schema():
    """Upgrade the database to include all AR fields"""
    ...
    # Add missing AR columns if they don't exist
    missing_columns = [
        ('ar_model_url', 'TEXT'),
        ('ar_preview_url', 'TEXT'), 
...
def add_diverse_products_safe():
    """Add diverse products with full AR support"""
...
if __name__ == "__main__":
    print("🚀 Starting Database Setup with Diverse Products...")
    upgrade_database_schema()
    add_diverse_products_safe()
    print("\n✅ Complete! Your database is now ready with diverse products!")
